...
const mode = typeof MODE === "string" ? MODE : "production";
const targetUpstream = typeof TARGET_UPSTREAM === "string" ? TARGET_UPSTREAM : "";
const customDomain = typeof CUSTOM_DOMAIN === "string" ? CUSTOM_DOMAIN : "";
